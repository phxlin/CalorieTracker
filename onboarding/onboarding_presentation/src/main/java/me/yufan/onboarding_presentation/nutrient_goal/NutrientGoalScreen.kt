package me.yufan.onboarding_presentation.nutrient_goal
    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                unit1 = stringResource(id = R.string.percent_carbs),
                unit2 = ""
            )
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            UnitTextField(
                ...
                unit1 = stringResource(id = R.string.percent_proteins),
                unit2 = ""
            )
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            UnitTextField(
                ...
                unit1 = stringResource(id = R.string.percent_fats),
                unit2 = ""
            )
        }
        ActionButton(
