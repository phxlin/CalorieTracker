...
import me.yufan.onboarding_presentation.components.UnitTextField
    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                isSelectable = true,
                isSelected1 = viewModel.selectedHeightUnit is BaseUnit.Centimeter,
                isSelected2 = viewModel.selectedHeightUnit is BaseUnit.Feet,
                onClick = {
                    viewModel.onUnitSwitch()
                },
                onValueChange = viewModel::onHeightEnter,
                unit1 = stringResource(id = R.string.cm),
                unit2 = stringResource(id = R.string.ft)
            )
        }
        ActionButton(
