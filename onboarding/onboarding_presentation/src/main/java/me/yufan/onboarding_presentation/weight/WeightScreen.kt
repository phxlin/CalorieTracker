    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                isSelectable = true,
                isSelected1 = viewModel.selectedWeightUnit is BaseUnit.Kilogram,
                isSelected2 = viewModel.selectedWeightUnit is BaseUnit.Pound,
                onClick = {
                    viewModel.onUnitSwitch()
                },
                onValueChange = viewModel::onWeightEnter,
                unit1 = stringResource(id = R.string.kg),
                unit2 = stringResource(id = R.string.lbs)
            )
        }
        ActionButton(
